...
#define PRODUCT_KEY             "a1B6N3eA9EW"
#define DEVICE_NAME             "CellSateRTU1"
#define DEVICE_SECRET           "C6ZWLlqFpGNJITSN5q2XTgbvEGaJputh"
...
//
    ...
    HAL_GetDeviceSecret(g_device_secret);
		   //20190419 print 
		printf("g_product_key = %s\r\n",g_product_key);
		printf("g_device_name = %s\r\n",g_device_name);
		printf("g_device_secret = %s\r\n",g_device_secret);
    /**< end*/
