...
#else
#define OTA_LOG_CRIT(...)       do{printf(__VA_ARGS__);printf("\r\n");}while(0)
#define OTA_LOG_ERROR(...)      do{printf(__VA_ARGS__);printf("\r\n");}while(0)
#define OTA_LOG_WRN(...)        do{printf(__VA_ARGS__);printf("\r\n");}while(0)
#define OTA_LOG_INFO(...)       do{printf(__VA_ARGS__);printf("\r\n");}while(0)
#define OTA_LOG_DEBUG(...)      do{printf(__VA_ARGS__);printf("\r\n");}while(0)
#endif
